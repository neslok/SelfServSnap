...
Invoke-Command -ComputerName UTIL  -scriptblock  {param($v1,$v2,$v3) C:\Users\Administrator\Documents\SnapSelfServ\SnapActions.ps1 -in_vmname $v1 -in_snap_name $v2 -user_action $v3 } -ArgumentList $in_vmname,$in_snap_name,$user_action
...
Invoke-Command -ComputerName UTIL  -scriptblock  {param($v1,$v2) C:\Users\Administrator\Documents\SnapSelfServ\SnapActions.ps1 -rs_snap_name $v1 -user_action $v2 } -ArgumentList $rs_snap_name,$user_action
...
Invoke-Command -ComputerName UTIL  -scriptblock  {param($v1,$v2) C:\Users\Administrator\Documents\SnapSelfServ\SnapActions.ps1 -rm_snap_name $v1 -user_action $v2 } -ArgumentList $rm_snap_name,$user_action
